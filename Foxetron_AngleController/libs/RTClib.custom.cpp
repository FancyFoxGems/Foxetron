...
void DS1307::writeSqwPinMode(Ds1307SqwPinMode mode)
{
	Wire.beginTransmission(DS1307_ADDRESS);
	Wire._I2C_WRITE(DS1307_CONTROL);
...
void DS1307::readNVRAM(uint8_t* buf, uint8_t size, uint8_t address)
{
...
void DS1307::writeNVRAM(uint8_t address, uint8_t* buf, uint8_t size)
{
	int addrByte = DS1307_NVRAM + address;
	Wire.beginTransmission(DS1307_ADDRESS);
	Wire._I2C_WRITE(addrByte);
...
uint8_t DS1307::readNVRAM(uint8_t address)
{
	uint8_t data;
...
void DS1307::writeNVRAM(uint8_t address, uint8_t data)
{
