...
{ 64, 64, 64, 64, 31, 31, 31, 31, 0 }; ///< Custom LCD character: Bottom block
const char phi_prompt_lcd_ch4[] PROGMEM =
{ 64, 64, 64, 64, 64, 31, 14, 4, 0 }; ///< Custom LCD character: Down triangle
const char phi_prompt_lcd_ch5[] PROGMEM =
{ 31, 31, 31, 31, 64, 31, 14, 4, 0 }; ///< Custom LCD character: Down triangle with block
const char phi_prompt_lcd_ch6[] PROGMEM =
...
const char * const yn_items[] PROGMEM ={ yn_00, yn_01 };  ///< This list  is used to render Y/N dialog
...
void simple_setup_6_buttons(LiquidCrystal_I2C * lcd, byte columns, byte rows, byte btn_u, byte btn_d, byte btn_l, byte btn_r, byte btn_b, byte btn_a)
{
	...
	{ "U" }; ///< All keys that act as the up key are listed here.
	static char down_keys[] =

	{ "D" }; ///< All keys that act as the down key are listed here.
	static char left_keys[] =

	{ "L" }; ///< All keys that act as the left key are listed here.
	static char right_keys[] =

	{ "R" }; ///< All keys that act as the right key are listed here.
	static char enter_keys[] =

	{ "B" }; ///< All keys that act as the enter key are listed here.
	static char escape_keys[] =

	{ "A" }; ///< All keys that act as the escape key are listed here.
	static char * fn_keys[] =

	{ up_keys, down_keys, left_keys, right_keys, enter_keys, escape_keys }; ///< All function key names are gathered here fhr phi_prompt.
	static byte pins[] =

	{ btn_u, btn_d, btn_l, btn_r, btn_b, btn_a };  ///< The digital pins for buttons
	static char mapping[] =

	{ 'U', 'D', 'L', 'R', 'B', 'A' };           ///< This is a list of names for each button.
	static phi_button_groups* my_btns = new phi_button_groups(mapping, pins, 6);
	static multiple_button_input * keypads[] =
...
LiquidCrystal_I2C * simple_setup_phi_2(byte columns, byte rows)
{
	...
	{ 5, 10, 11, 4, A0, A1 };  ///< The digital pins for buttons
	static char mapping[] =
...
LiquidCrystal_I2C * simple_setup_phi_3(byte columns, byte rows)
{
	...
	{ A0 };  ///< The digital pins for buttons
	static int values[] =

	{ 0, 417, 562, 647, 672, 709 }; //These numbers need to increase monotonically.
	static char mapping[] =
